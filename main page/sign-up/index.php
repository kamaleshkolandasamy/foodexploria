    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form style="max-width: 700px;" role="form" action="demo.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3"><label class="form-label">Email*</label><input class="form-control" type="email" autocomplete="off" required="" placeholder="Enter your Email-id" name="user"></div>
