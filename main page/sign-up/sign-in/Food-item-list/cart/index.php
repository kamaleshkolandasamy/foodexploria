                ...
                <tr id="i1">
                  <th scope="row" class="border-0">
                    <div class="p-2" id="item1" style="display:none" >
                      <img src="assets/img/megacv 625.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">Mega-CV 625</a></h5><span class="text-muted font-weight-normal font-italic d-block">Medicine-item: 1</span>
                      </div>
                    </div>
                  </th>
                ...
                <tr>
                   <th scope="row"  class="border-0">
                    <div class="p-2" id="item2" style="display:none">
                      <img src="assets/img/dolo.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"><a href="#" class="text-dark d-inline-block">Dolo 650</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item2</span>
                      </div>
                    </div>
                  </th>
                ...
                <tr>
                  <th scope="row"  class="border-0">
                    <div class="p-2" id="item3" style="display:none">
                      <img src="assets/img/naxdom 500.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Naxdom 500</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 3</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row"  class="border-0">
                    <div class="p-2" id="item4" style="display:none">
                      <img src="assets/img/okacet cold.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Okacet Cold Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 4</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row"  class="border-0">
                    <div class="p-2" id="item5" style="display:none">
                      <img src="assets/img/norflox.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Norflox-TZ RF Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 5</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row" class="border-0">
                    <div class="p-2" id="item6" style="display:none">
                      <img src="assets/img/hifenc.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Hifenac-P Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 6</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row" class="border-0">
                    <div class="p-2" id="item7" style="display:none">
                      <img src="assets/img/kuffq.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Kuff Q Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 7</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row" class="border-0">
                    <div class="p-2" id="item8" style="display:none">
                      <img src="assets/img/glucored.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Glucored Forte Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 8</span>
                      </div>
                    </div>
                ...
                <tr>
                  <th scope="row" class="border-0">
                    <div class="p-2" id="item9" style="display:none">
                      <img src="assets/img/amlokind.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Amlokind-AT Tablet</a></h5><span class="text-muted font-weight-normal font-italic">Medicine-item: 9</span>
                      </div>
                    </div>
